...
(function (arrayexjs) {
    ...
    arrayexjs.concatEnumerator = concatEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.distinctEnumerator = distinctEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.exceptEnumerator = exceptEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.groupByEnumerator = groupByEnumerator;
...
(function (arrayexjs) {
    ...
    arrayexjs.intersectEnumerator = intersectEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.joinEnumerator = joinEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.orderByEnumerable = orderByEnumerable;
...
(function (arrayexjs) {
    ...
    arrayexjs.reverseEnumerator = reverseEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.selectEnumerator = selectEnumerator;
    ...
    arrayexjs.selectManyEnumerator = selectManyEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.skipEnumerator = skipEnumerator;
    ...
    arrayexjs.skipWhileEnumerator = skipWhileEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.takeEnumerator = takeEnumerator;
    ...
    arrayexjs.takeWhileEnumerator = takeWhileEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.unionEnumerator = unionEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.whereEnumerator = whereEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    ...
    arrayexjs.zipEnumerator = zipEnumerator;
})(arrayexjs || (arrayexjs = {}));
var arrayexjs;
(function (arrayexjs) {
    var Enumerable = (function () {
        ...
        Enumerable.prototype.concat = function (second) {
            ...
            e.getEnumerator = function () {
                return arrayexjs.concatEnumerator(_this, second);
            };
            return e;
        };
        ...
        Enumerable.prototype.distinct = function (comparer) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.distinctEnumerator(_this, comparer);
            };
            return e;
        };
        Enumerable.prototype.except = function (second, comparer) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.exceptEnumerator(_this, second, comparer);
            };
            return e;
        };
        ...
        Enumerable.prototype.groupBy = function (keySelector, comparer) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.groupByEnumerator(_this, keySelector, comparer);
            };
            return e;
        };
        Enumerable.prototype.intersect = function (second, comparer) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.intersectEnumerator(_this, second, comparer);
            };
            return e;
        };
        Enumerable.prototype.join = function (inner, outerKeySelector, innerKeySelector, resultSelector, comparer) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.joinEnumerator(_this, inner, outerKeySelector, innerKeySelector, resultSelector, comparer);
            };
            return e;
        };
        ...
        Enumerable.prototype.orderBy = function (keySelector, comparer) {
            return arrayexjs.orderByEnumerable(this, keySelector, false, comparer);
        };
        Enumerable.prototype.orderByDescending = function (keySelector, comparer) {
            return arrayexjs.orderByEnumerable(this, keySelector, true, comparer);
        };
        Enumerable.prototype.reverse = function () {
            var _this = this;
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.reverseEnumerator(_this);
            };
            return e;
        };
        Enumerable.prototype.select = function (selector) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.selectEnumerator(_this, selector);
            };
            return e;
        };
        Enumerable.prototype.selectMany = function (selector) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.selectManyEnumerator(_this, selector);
            };
            return e;
        };
        Enumerable.prototype.skip = function (count) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.skipEnumerator(_this, count);
            };
            return e;
        };
        Enumerable.prototype.skipWhile = function (predicate) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.skipWhileEnumerator(_this, predicate);
            };
            return e;
        };
        ...
        Enumerable.prototype.take = function (count) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.takeEnumerator(_this, count);
            };
            return e;
        };
        Enumerable.prototype.takeWhile = function (predicate) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.takeWhileEnumerator(_this, predicate);
            };
            return e;
        };
        ...
        Enumerable.prototype.union = function (second, comparer) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.unionEnumerator(_this, second, comparer);
            };
            return e;
        };
        Enumerable.prototype.where = function (filter) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.whereEnumerator(_this, filter);
            };
            return e;
        };
        Enumerable.prototype.zip = function (second, resultSelector) {
            ...
            var e = new Enumerable();
            e.getEnumerator = function () {
                return arrayexjs.zipEnumerator(_this, second, resultSelector);
            };
            return e;
        };
        return Enumerable;
